...
public class QQJSONMsgCreator {
     ...
     * @return 讨论组消息
     */
    String getResponseJson_sendDisGroupMsg(String discussid, String msg){
     ...
     * @return 群消息
     */
    String getResponseJson_sendGroupMsg(String groupid, String msg){
        Map<String, Object> paramMap = createParamMap(
     ...
     * @return 私信
     */
    String getResponseJson_sendMsgPrivate(String QQID, String msg){
        Map<String, Object> paramMap = createParamMap(
     ...
     * @return 赞
     */
    String getResponseJson_sendPraise(String QQID){
     ...
     * @return  全群禁言
     */
    String getResponseJson_setAllGroupBanned(String QQID, String groupid, String enableban){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"QQID", QQID},
                new Object[]{"groupid", groupid},
     ...
     * @return 设置匿名群员禁言
     */
    String getResponseJson_setAnoGroupMemberBanned(String groupid, Long duration, String anomymous){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"groupid", groupid},
     ...
     * @return 讨论组退出
     */
    String getResponseJson_setDisGroupExit(String discussid){
     ...
     * @return
     */
    String getResponseJson_setFriendAddRequest(String responseoperation, String remark, String responseflag){
        Map<String, Object> paramMap = createParamMap(
     ...
     * @return 群管理员
     */
    String getResponseJson_setGroupAdmin(String QQID, String groupid, Boolean setadmin){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"QQID", QQID},
                new Object[]{"groupid", groupid},
     ...
     * @return  群匿名设置
     */
    String getResponseJson_setGroupAno(String groupid, Boolean enableanomymous){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"groupid", groupid},
     ...
     * @return 置群退出
     */
    String getResponseJson_setGroupExit(String groupid, Boolean isdismiss){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"groupid", groupid},
     ...
     * @return  置群添加请求
     */
    String getResponseJson_setGroupJoinResquest(String requesttype, String responseoperation, String reason, String responseflag){
        Map<String, Object> paramMap = createParamMap(
     ...
     * @return 置群员禁言
     */
    String getResponseJson_setGroupMemberBanned(String QQID, String groupid, Long duration){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"QQID", QQID},
                new Object[]{"groupid", groupid},
                new Object[]{"duration", duration}
     ...
     * @return  群成员名片
     */
    String getResponseJson_setGroupMemberCard(String QQID, String groupid, String newcard){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"QQID", QQID},
                new Object[]{"groupid", groupid},
     ...
     * @return
     */
    String getResponseJson_setGroupMemberRemove(String QQID, String groupid, Boolean rejectaddrequest){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"QQID", QQID},
                new Object[]{"groupid", groupid},
     ...
     * @return  群成员专属头衔
     */
    String getResponseJson_setGroupMemberSpecialTitle(String QQID, String groupid, Long duration, String newspecialtitle){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"QQID", QQID},
                new Object[]{"groupid", groupid},
                new Object[]{"duration", duration},
    ...
    String getResponseJson_InfoForLoginInGroups(String QQID){
        ...
        return mapToBeanJson(new InfoForLoginInGroups(), paramMap);
    }
     ...
     * @return 请求获取群中某用户信息
     */
    String getResponseJson_InfoGroupMember(String groupid, String QQID, String nocache){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"groupid", groupid},
                new Object[]{"QQID", QQID},
     ...
     * @return 请求获取当前账号的昵称
     */
    String getResponseJson_InfoLoginNick(){
     ...
     * @return 请求获取当前账号的qq
     */
    String getResponseJson_InfoLoginQQ(){
     ...
     * @return  请求获取陌生人信息
     */
    String getResponseJson_InfoStranger(String QQID, String nocache){
        Map<String, Object> paramMap = createParamMap(
                new Object[]{"QQID", QQID},
                new Object[]{"nocache", nocache}
        );
