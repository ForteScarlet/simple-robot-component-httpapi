...
> 如果需要获得更好的阅读体验，请前往 [原文档](http://simple-robot-doc.forte.love/) -> `组件-酷Q-HTTP TO CQ` -> `快速开始` 处阅读
>或
>[原文档](https://www.kancloud.cn/forte-scarlet/simple-coolq-doc/) -> `组件-酷Q-HTTP TO CQ` -> `快速开始` 处阅读
> 或尝试直接进入[快速开始](http://simple-robot-doc.forte.love/1519579)
